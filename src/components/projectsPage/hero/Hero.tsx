  ...
  return (
    ...
    `,
      ...
      <Container className="pt-[132px] lg:pt-[219px] pb-14 lg:pb-30">
        <PageTitle className="mb-6 lg:mb-9">Projekter</PageTitle>
        <motion.p
          initial="hidden"
          whileInView="visible"
          exit="exit"
        ...
        >
          Se udvalgte projekter udført af Nbyg – tag, terrasse og renovering i
          København og på Bornholm. Få inspiration til dit næste byggeprojekt.
        </motion.p>
      </Container>
    </motion.section>
  );
