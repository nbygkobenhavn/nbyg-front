...
export default function Hero() {
  return (
    ...
    >
      <Image
        src="/images/galleriPage/hero/hero.webp"
        fill
        alt="gallery image"
        sizes="100vw"
    ...
    `,
      ...
      <Container className="pt-[132px] lg:pt-[219px] pb-14 lg:pb-30">
        <PageTitle className="mb-6 lg:mb-9">Galleri</PageTitle>
        <motion.p
          initial="hidden"
          whileInView="visible"
          exit="exit"
        ...
        >
          Udforsk vores projekter – fra moderne terrasser til tage og indendørs
          renoveringer. Hvert arbejde er udført med sans for detaljer og
          kvalitet, vi er stolte af.
        </motion.p>
      </Container>
    </motion.section>
  );
